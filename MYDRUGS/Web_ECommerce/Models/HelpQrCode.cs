    ...
    public class HelpQrCode : Controller
    {
        ...
        public async Task<IActionResult> Download(CompraUsuario compraUsuario, IWebHostEnvironment _environment)
        {
            ...
            using (var doc = new PdfSharpCore.Pdf.PdfDocument())
            {
                ...
                relatorioCobranca.DrawString("BOLETO", titulo, corFonte, new XRect(0, 65, page.Width, page.Height));
                ...
                detalhes.DrawString("NU PAGAMENTOS S.A", tituloInfo_1, corFonte, new XRect(150, alturaTituloDetalhesY, page.Width, page.Height));

                alturaTituloDetalhesY += 9;
                detalhes.DrawString("Código de Barras", tituloInfo_1, corFonte, new XRect(25, alturaTituloDetalhesY, page.Width, page.Height));
                ...
                try
                {
                    var img = await GeraQrCode("FAZ O PIX");
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(), contentType, "MYDRUGS.pdf");
                }
